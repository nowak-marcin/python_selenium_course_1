...
from python_selenium_course_1.src.pages.locators.CheckoutPageLocator import CheckoutPageLocator
...
class CheckoutPage(CheckoutPageLocator):
    ...
    def click_place_order(self):
        self.SeleniumExtended.wait_and_click(self.PLACE_ORDER_BTN)
